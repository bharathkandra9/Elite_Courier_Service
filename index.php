    ...
    <div class="container">
      <div class="row align-items-center">
        ...
        <div class="col-11 col-xl-2 site-logo">
          <h1 class="mb-0"><a href="index.php" class="text-white h5 mb-0">ECS Service</a></h1>
        </div>
    ...
    <div class="container">
      <div class="row align-items-center justify-content-center text-center">
        ...
        <div class="col-md-8" data-aos="fade-up" data-aos-delay="400">
          ...
          <h1 class="text-white font-weight-light text-uppercase font-weight-bold" data-aos="fade-up">WELCOME TO ECS SERVICE</h1>
          <p class="mb-5" data-aos="fade-up" data-aos-delay="100">Your Wish Our Command</p>
    ...
    <div class="container">
      <div class="row mb-5">
        ...
        <div class="col-md-6 order-md-1" data-aos="fade-up">
          ...
          <p>ECS is a Indian premier domestic courier service provider. 
            With the strength of an experienced and talented team, ECS functions with the utmost confidence in the broadest coverage, security, and timely delivery of your important documents and packages.
            ECS also has a strong background in logistics management. 
             As a result of the trust we have built with our corporate clients,ECS is now the official courier for a number of entities in India.
             ECS upholds high service standards and quality levels to ensure that your packages and documents are handled by professionals.</p>
      ...
      <div class="row">
        ...
        <div class="col-md-5">
          ...
          <div class="p-4 mb-3 bg-white">
            ...
            <p class="mb-4">Patna University Campus, Patna, Bihar 800005</p>

            <p class="mb-0 font-weight-bold">Phone</p>
            <p class="mb-4"><a href="#">9666457147</a></p>
